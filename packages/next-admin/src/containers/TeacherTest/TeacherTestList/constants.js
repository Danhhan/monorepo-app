...
export const TEACHERS_RATING = [
  {
    label: <FormattedMessage defaultMessage="Từ 4-5" />,
    value: '',
    color: '#006BB4',
  },
  {
    label: <FormattedMessage defaultMessage="Từ 3-4" />,
    value: '',
    color: '#219653',
  },
  {
    label: <FormattedMessage defaultMessage="Từ 2-3 " />,
    value: '',
    color: '#219653',
  },
  {
    label: <FormattedMessage defaultMessage="Từ 1-2 " />,
    value: '',
    color: '#219653',
  },
];
